...
const TableCustomer = () => {
    ...
    const handleClick = (event: React.MouseEvent<HTMLElement>, id_cust: number) => {
        setClickedRowId(id_cust);
    ...
    const handleEditCustomer = (id_cust: number) => () => {
        navigate("/edit", { state: { id_cust: id_cust } });
    };
                                                                ...
                                                                <MenuItem
                                                                    ...
                                                                    onClick={
                                                                        option === 'Delete'
                                                                            ...
                                                                            : option === 'Edit'
                                                                                ? handleEditCustomer(row.id_cust)
                                                                                : handleClose
                                                                    }
                                                                >
                                                                    {option}
